...
Rebuild UsはAmong UsのModであり、新しい役職やゲームモード、カスタムマップを追加します。\
...
なお、アセットバンドルはリポジトリに含まれていません。\
Pull Requestは歓迎しますが、マージされるかどうかは保証できません。\
また、外部からのIssueは受け付けておりません。\
開発者が身内で使用する目的でのみ開発されています。\
