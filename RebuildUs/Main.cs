...
global using RebuildUs.Core;
global using RebuildUs.Features;
global using RebuildUs.Network;
global using RebuildUs.UI;
global using RebuildUs.UI.Consoles;
global using RebuildUs.Features.Cosmetics;
global using RebuildUs.Features.CustomGameModes;
global using RebuildUs.Features.CustomOptions;
global using RebuildUs.Core.EndGame;
global using RebuildUs.Core.Random;
global using RebuildUs.Network.RPC;
...
public class RebuildUs : BasePlugin
{
    ...
    internal const string MOD_VERSION = "2.2.1";
