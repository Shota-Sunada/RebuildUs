...
{
    public CustomOption CommonTaskOption = Normal(ids.commonId, type, TranslateKey.NumCommonTask, defaultValue.commonTasks, 0f, 4f, 1f, parent);
    public CustomOption ShortTaskOption = Normal(ids.shortId, type, TranslateKey.NumShortTask, defaultValue.shortTasks, 0f, 15f, 1f, parent);
    public CustomOption LongTaskOption = Normal(ids.longId, type, TranslateKey.NumLongTask, defaultValue.longTasks, 0f, 23f, 1f, parent);
