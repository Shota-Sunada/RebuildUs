...
internal sealed class CustomHat : CustomHatHashes
{
    ...
    internal bool Bounce { get; set; }

    [JsonPropertyName("climbresource")]
    internal string ClimbResource { get; set; }
    ...
    internal string BackResource { get; set; }

    [JsonPropertyName("backflipresource")]
    internal string BackFlipResource { get; set; }

    [JsonPropertyName("flipresource")]
    internal string FlipResource { get; set; }
}