...
internal static class RoleData
{
    ...
    [
        ...
        new(RoleType.Engineer,
            RoleTeam.Crewmate,
            typeof(MultiRoleBase<Engineer>),
            () => Engineer.NameColor,
            () => CustomOptionHolder.EngineerSpawnRate),
        ...
        new(RoleType.Detective,
            RoleTeam.Crewmate,
            typeof(MultiRoleBase<Detective>),
            () => Detective.NameColor,
            () => CustomOptionHolder.DetectiveSpawnRate),
        new(RoleType.TimeMaster,
            RoleTeam.Crewmate,
            typeof(SingleRoleBase<TimeMaster>),
            () => TimeMaster.NameColor,
            () => CustomOptionHolder.TimeMasterSpawnRate),
        ...
        new(RoleType.SecurityGuard,
            RoleTeam.Crewmate,
            typeof(SingleRoleBase<SecurityGuard>),
            () => SecurityGuard.NameColor,
            () => CustomOptionHolder.SecurityGuardSpawnRate),
        ...
        new(RoleType.Madmate,
            RoleTeam.Crewmate,
            typeof(MultiRoleBase<MadmateRole>),
            () => MadmateRole.NameColor,
            () => CustomOptionHolder.MadmateRoleSpawnRate),
        new(RoleType.Suicider,
            RoleTeam.Crewmate,
            typeof(MultiRoleBase<Suicider>),
            () => Suicider.NameColor,
            () => CustomOptionHolder.SuiciderSpawnRate),

        // Impostor
        new(RoleType.BountyHunter,
            RoleTeam.Impostor,
            typeof(SingleRoleBase<BountyHunter>),
            () => BountyHunter.NameColor,
            () => CustomOptionHolder.BountyHunterSpawnRate),
        new(RoleType.Godfather,
            RoleTeam.Impostor,
            typeof(SingleRoleBase<Mafia.Godfather>),
            () => Mafia.NameColor,
            () => CustomOptionHolder.MafiaSpawnRate),
        new(RoleType.Mafioso,
            RoleTeam.Impostor,
            typeof(SingleRoleBase<Mafia.Mafioso>),
            () => Mafia.NameColor,
            () => CustomOptionHolder.MafiaSpawnRate),
        new(RoleType.Janitor,
            RoleTeam.Impostor,
            typeof(SingleRoleBase<Mafia.Janitor>),
            () => Mafia.NameColor,
            () => CustomOptionHolder.MafiaSpawnRate),
        new(RoleType.Morphing,
            RoleTeam.Impostor,
            typeof(MultiRoleBase<Morphing>),
            () => Morphing.NameColor,
            () => CustomOptionHolder.MorphingSpawnRate),
        new(RoleType.Camouflager,
            RoleTeam.Impostor,
            typeof(SingleRoleBase<Camouflager>),
            () => Camouflager.NameColor,
            () => CustomOptionHolder.CamouflagerSpawnRate),
        ...
        new(RoleType.Trickster,
            RoleTeam.Impostor,
            typeof(SingleRoleBase<Trickster>),
            () => Trickster.NameColor,
            () => CustomOptionHolder.TricksterSpawnRate),
        ...
        new(RoleType.EvilHacker,
            RoleTeam.Impostor,
            typeof(MultiRoleBase<EvilHacker>),
            () => EvilHacker.NameColor,
            () => CustomOptionHolder.EvilHackerSpawnRate),
        new(RoleType.EvilTracker,
            RoleTeam.Impostor,
            typeof(MultiRoleBase<EvilTracker>),
            () => EvilTracker.NameColor,
            () => CustomOptionHolder.EvilTrackerSpawnRate),

        // Neutral
        new(RoleType.Jester, RoleTeam.Neutral, typeof(SingleRoleBase<Jester>), () => Jester.NameColor, () => CustomOptionHolder.JesterSpawnRate),
        new(RoleType.Arsonist,
            RoleTeam.Neutral,
            typeof(SingleRoleBase<Arsonist>),
            () => Arsonist.NameColor,
            () => CustomOptionHolder.ArsonistSpawnRate),
        ...
        new(RoleType.NiceGuesser,
            RoleTeam.Crewmate,
            typeof(SingleRoleBase<Guesser.NiceGuesser>),
            () => Guesser.NiceGuesser.NameColor,
            () => CustomOptionHolder.GuesserSpawnRate),
        new(RoleType.EvilGuesser,
            RoleTeam.Impostor,
            typeof(SingleRoleBase<Guesser.EvilGuesser>),
            () => Guesser.EvilGuesser.NameColor,
            () => CustomOptionHolder.GuesserSpawnRate),
        new(RoleType.NiceSwapper,
            RoleTeam.Crewmate,
            typeof(SingleRoleBase<Swapper>),
            () => Swapper.NameColor,
            () => CustomOptionHolder.SwapperSpawnRate),
        new(RoleType.EvilSwapper,
            RoleTeam.Impostor,
            typeof(SingleRoleBase<Swapper>),
            () => Palette.ImpostorRed,
            () => CustomOptionHolder.SwapperSpawnRate),
