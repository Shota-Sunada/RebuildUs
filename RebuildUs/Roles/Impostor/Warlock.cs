...
internal class Warlock : MultiRoleBase<Warlock>
{
    ...
    {
        if (!PlayerControl.LocalPlayer.IsRole(RoleType.Warlock) || WarlockCurseButton == null) return;
    ...
    internal static void MakeButtons(HudManager hm)
    {
        WarlockCurseButton = new(() =>
        {
            ...
            {
                MurderAttemptResult murder = Helpers.CheckMurderAttemptAndKill(Local._curseVictim, Local._curseVictimTarget, showAnimation: false);
                ...
                if (RootTime > 0)
                {
                    ...
                    {
                        // Delayed action
                        if (Mathf.Approximately(p, 1f)) PlayerControl.LocalPlayer.moveable = true;
                    })));
                }
        ...
        }, () => { return PlayerControl.LocalPlayer.IsRole(RoleType.Warlock) && PlayerControl.LocalPlayer.IsAlive(); }, () => { return ((Local._curseVictim == null && Local._currentTarget != null) || (Local._curseVictim != null && Local._curseVictimTarget != null)) && PlayerControl.LocalPlayer.CanMove; }, () =>
        {
            WarlockCurseButton.Timer = WarlockCurseButton.MaxTimer;
            WarlockCurseButton.Sprite = AssetLoader.CurseButton;
            WarlockCurseButton.ButtonText = Tr.Get(TrKey.CurseText);
