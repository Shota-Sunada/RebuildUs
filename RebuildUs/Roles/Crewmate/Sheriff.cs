...
public class Sheriff : RoleBase<Sheriff>
{
    ...
    public static bool MisfireKillsTarget
    {
    ...
    public static bool MadmateCanDieToSheriff
    {
        get => CustomOptionHolder.MadmateCanDieToSheriff.GetBool();
    }

    public static bool MadmateRoleCanDieToSheriff
    {
        get => CustomOptionHolder.MadmateRoleCanDieToSheriff.GetBool();
    }

    public static bool SuiciderCanDieToSheriff
    {
    ...
    public static bool SheriffCanKillNoDeadBody
    {
    ...
    public static void MakeButtons(HudManager hm)
    {
        ...
        SheriffNumShotsText = GameObject.Instantiate(_sheriffKillButton.ActionButton.cooldownTimerText, _sheriffKillButton.ActionButton.cooldownTimerText.transform.parent);
