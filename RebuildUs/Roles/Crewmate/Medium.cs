    ...
    public static void MakeButtons(HudManager hm)
    {
        MediumButton = new CustomButton(
            ...
            () =>
            {
                ...
                string typeOfColor = Helpers.IsLighterColor(Local.Target.KillerIfExisting.Data.DefaultOutfit.ColorId) ? Tr.Get(TrKey.DetectiveColorLight) : Tr.Get(TrKey.DetectiveColorDark);
                ...
                msg = randomNumber == 0
                    ? string.Format(Tr.Get(TrKey.MediumQuestion1), RoleInfo.GetRolesString(Local.Target.Player, false, includeHidden: true)) + name
                    : randomNumber == 1
                        ...
                        : string.Format(Tr.Get(TrKey.MediumQuestion4), RoleInfo.GetRolesString(Local.Target.KillerIfExisting, false, includeHidden: true)) + name;
