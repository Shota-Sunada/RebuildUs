...
internal sealed class Couple(PlayerControl lover1, PlayerControl lover2, Color color)
{
    ...
    internal bool ExistingWithKiller { get => Existing && (Lover1.IsRole(RoleType.Jackal) || Lover2.IsRole(RoleType.Jackal)) && (Lover1.IsRole(RoleType.Sidekick) || Lover2.IsRole(RoleType.Sidekick)) && (Lover1.IsTeamImpostor() || Lover2.IsTeamImpostor()); }
