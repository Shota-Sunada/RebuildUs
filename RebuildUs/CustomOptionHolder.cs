...
public static class CustomOptionHolder
{
    ...
    public static void Load()
    {
        ...
        thiefModeWhoCanThiefsKill = CustomOption.Normal(536, CustomOptionType.General, TrKey.PoliceAndThievesWhoCanThievesKill, new string[] { Tr.Get(TrKey.PoliceAndThievesTaser), Tr.Get(TrKey.PoliceAndThievesAll), Tr.Get(TrKey.PoliceAndThievesNobody) }, gamemodeSettings);
        ...
        battleRoyaleMatchType = CustomOption.Normal(550, CustomOptionType.General, TrKey.BattleRoyaleMatchType, new string[] { Tr.Get(TrKey.BattleRoyaleAllVsAll), Tr.Get(TrKey.BattleRoyaleTeamBattle), Tr.Get(TrKey.BattleRoyaleScoreBattle) }, gamemodeSettings);
