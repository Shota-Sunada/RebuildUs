...
public static class CustomOptionHolder
{
    ...
    public static readonly string[] PRESETS = [Tr.Get("Preset1"), Tr.Get("Preset2"), Tr.Get("Preset3"), Tr.Get("Preset4"), Tr.Get("Preset5")];
    ...
    public static void Load()
    {
        ...
        #region GAME OPTIONS
        GameOptions = CustomOption.Header(19, CustomOptionType.General, "GameOptions", true, "GameOptions");
        MaxNumberOfMeetings = CustomOption.Normal(20, CustomOptionType.General, "MaxNumberOfMeetings", 10, 0, 15, 1);
        ...
        RestrictDevices = CustomOption.Normal(60, CustomOptionType.General, "RestrictDevices", [Tr.Get("Off"), Tr.Get("RestrictPerTurn"), Tr.Get("RestrictPerGame")]);
        RestrictAdmin = CustomOption.Normal(61, CustomOptionType.General, "RestrictAdmin", true, RestrictDevices);
        RestrictAdminTime = CustomOption.Normal(62, CustomOptionType.General, "RestrictAdminTime", 30f, 0f, 600f, 1f, RestrictAdmin);
        ...
        RestrictCamerasTime = CustomOption.Normal(65, CustomOptionType.General, "RestrictCamerasTime", 30f, 0f, 600f, 1f, RestrictCameras);
        ...
        RestrictVitalsTime = CustomOption.Normal(68, CustomOptionType.General, "RestrictVitalsTime", 30f, 0f, 600f, 1f, RestrictVitals);
        RestrictVitalsText = CustomOption.Normal(69, CustomOptionType.General, "RestrictVitalsText", true, RestrictVitals);
        #endregion

        #region DISCORD OPTIONS
        EnableDiscordAutoMute = CustomOption.Header(110, CustomOptionType.General, "EnableDiscordAutoMute", false, "DiscordOptions");
        EnableDiscordEmbed = CustomOption.Normal(111, CustomOptionType.General, "EnableDiscordEmbed", false);
        #endregion

        #region POLUS OPTIONS
        PolusAdditionalVents = CustomOption.Header(70, CustomOptionType.General, "PolusAdditionalVents", true, "PolusOptions");
        PolusSpecimenVital = CustomOption.Normal(71, CustomOptionType.General, "PolusSpecimenVital", true);
        PolusRandomSpawn = CustomOption.Normal(72, CustomOptionType.General, "PolusRandomSpawn", true);
        #endregion

        #region AIRSHIP OPTIONS
        AirshipOptimize = CustomOption.Header(80, CustomOptionType.General, "AirshipOptimize", false, "AirshipOptions");
        AirshipEnableWallCheck = CustomOption.Normal(81, CustomOptionType.General, "AirshipEnableWallCheck", true);
        AirshipReactorDuration = CustomOption.Normal(82, CustomOptionType.General, "AirshipReactorDuration", 60f, 0f, 600f, 1f);
        AirshipRandomSpawn = CustomOption.Normal(83, CustomOptionType.General, "AirshipRandomSpawn", false);
        AirshipAdditionalSpawn = CustomOption.Normal(84, CustomOptionType.General, "AirshipAdditionalSpawn", true);
        AirshipSynchronizedSpawning = CustomOption.Normal(85, CustomOptionType.General, "AirshipSynchronizedSpawning", true);
        AirshipSetOriginalCooldown = CustomOption.Normal(86, CustomOptionType.General, "AirshipSetOriginalCooldown", false);
        AirshipInitialDoorCooldown = CustomOption.Normal(87, CustomOptionType.General, "AirshipInitialDoorCooldown", 0f, 0f, 60f, 1f);
        AirshipInitialSabotageCooldown = CustomOption.Normal(88, CustomOptionType.General, "AirshipInitialSabotageCooldown", 15f, 0f, 60f, 1f);
        AirshipOldAdmin = CustomOption.Normal(89, CustomOptionType.General, "AirshipOldAdmin", false);
        AirshipRestrictedAdmin = CustomOption.Normal(90, CustomOptionType.General, "AirshipRestrictedAdmin", false);
        AirshipDisableGapSwitchBoard = CustomOption.Normal(91, CustomOptionType.General, "AirshipDisableGapSwitchBoard", false);
        AirshipDisableMovingPlatform = CustomOption.Normal(92, CustomOptionType.General, "AirshipDisableMovingPlatform", false);
        AirshipAdditionalLadder = CustomOption.Normal(93, CustomOptionType.General, "AirshipAdditionalLadder", false);
        AirshipOneWayLadder = CustomOption.Normal(94, CustomOptionType.General, "AirshipOneWayLadder", false);
        AirshipReplaceSafeTask = CustomOption.Normal(95, CustomOptionType.General, "AirshipReplaceSafeTask", false);
        AirshipAdditionalWireTask = CustomOption.Normal(96, CustomOptionType.General, "AirshipAdditionalWireTask", false);
        #endregion
        ...
        MayorTasksNeededToSeeVoteColors = CustomOption.Normal(1003, CustomOptionType.Crewmate, "MayorTasksNeededToSeeVoteColors", 3f, 1f, 10f, 1f, MayorCanSeeVoteColors);
        ...
        MedicShowShielded = CustomOption.Normal(1031, CustomOptionType.Crewmate, "MedicShowShielded", [Tr.Get("MedicShowShieldedAll"), Tr.Get("MedicShowShieldedBoth"), Tr.Get("MedicShowShieldedMedic")], MedicSpawnRate);
        ...
        SeerMode = CustomOption.Normal(1041, CustomOptionType.Crewmate, "SeerMode", [Tr.Get("SeerModeBoth"), Tr.Get("SeerModeFlash"), Tr.Get("SeerModeSouls")], SeerSpawnRate);
        ...
        DetectiveReportNameDuration = CustomOption.Normal(1064, CustomOptionType.Crewmate, "DetectiveReportNameDuration", 10f, 0, 60, 2.5f, DetectiveSpawnRate);
        ...
        SwapperSpawnRate = new(1130, CustomOptionType.Neutral, $"{nameof(Swapper)}", Swapper.NameColor, 1);
        ...
        SheriffCooldown = CustomOption.Normal(1161, CustomOptionType.Crewmate, "SheriffCooldown", 30f, 2.5f, 60f, 2.5f, SheriffSpawnRate, format: "unitSeconds");
        SheriffNumShots = CustomOption.Normal(1162, CustomOptionType.Crewmate, "SheriffNumShots", 2f, 1f, 15f, 1f, SheriffSpawnRate, format: "unitShots");
        SheriffMisfireKillsTarget = CustomOption.Normal(1163, CustomOptionType.Crewmate, "SheriffMisfireKillsTarget", false, SheriffSpawnRate);
        SheriffCanKillNoDeadBody = CustomOption.Normal(1164, CustomOptionType.Crewmate, "SheriffCanKillNoDeadBody", true, SheriffSpawnRate);
        SheriffCanKillNeutrals = CustomOption.Normal(1165, CustomOptionType.Crewmate, "SheriffCanKillNeutrals", false, SheriffSpawnRate);

        MadmateRoleSpawnRate = new(1170, CustomOptionType.Crewmate, RoleType.Madmate, MadmateRole.NameColor, 3);
        MadmateRoleCanDieToSheriff = CustomOption.Normal(1171, CustomOptionType.Crewmate, "MadmateCanDieToSheriff", true, MadmateRoleSpawnRate);
        MadmateRoleCanEnterVents = CustomOption.Normal(1172, CustomOptionType.Crewmate, "MadmateCanEnterVents", true, MadmateRoleSpawnRate);
        MadmateRoleHasImpostorVision = CustomOption.Normal(1173, CustomOptionType.Crewmate, "MadmateHasImpostorVision", false, MadmateRoleSpawnRate);
        MadmateRoleCanSabotage = CustomOption.Normal(1174, CustomOptionType.Crewmate, "MadmateCanSabotage", false, MadmateRoleSpawnRate);
        MadmateRoleCanFixComm = CustomOption.Normal(1175, CustomOptionType.Crewmate, "MadmateCanFixComm", false, MadmateRoleSpawnRate);
        MadmateRoleCanKnowImpostorAfterFinishTasks = CustomOption.Normal(1176, CustomOptionType.Crewmate, "MadmateCanKnowImpostorAfterFinishTasks", false, MadmateRoleSpawnRate);
        ...
        SuiciderCanDieToSheriff = CustomOption.Normal(1191, CustomOptionType.Crewmate, "SuiciderCanDieToSheriff", true, SuiciderSpawnRate);
        SuiciderCanEnterVents = CustomOption.Normal(1192, CustomOptionType.Crewmate, "SuiciderCanEnterVents", true, SuiciderSpawnRate);
        SuiciderHasImpostorVision = CustomOption.Normal(1193, CustomOptionType.Crewmate, "SuiciderHasImpostorVision", false, SuiciderSpawnRate);
        SuiciderCanFixComm = CustomOption.Normal(1194, CustomOptionType.Crewmate, "SuiciderCanFixComm", false, SuiciderSpawnRate);
        SuiciderCanKnowImpostorAfterFinishTasks = CustomOption.Normal(1195, CustomOptionType.Crewmate, "SuiciderCanKnowImpostorAfterFinishTasks", false, SuiciderSpawnRate);
        ...
        MafiaSpawnRate = new(2010, CustomOptionType.Impostor, $"{nameof(Mafia)}", Mafia.NameColor, 1);
        ...
        CreatedMadmateAbility = CustomOption.Normal(2042, CustomOptionType.Impostor, "MadmateAbility", [Tr.Get("MadmateNone"), Tr.Get("MadmateFanatic")], EvilHackerCanCreateMadmate);
        ...
        MadmateType = CustomOption.Normal(4001, CustomOptionType.Modifier, "MadmateType", [Tr.Get("MadmateDefault"), Tr.Get("MadmateWithRole"), Tr.Get("MadmateRandom")], MadmateSpawnRate);
        ...
        MadmateAbility = CustomOption.Normal(4003, CustomOptionType.Modifier, "MadmateAbility", [Tr.Get("MadmateNone"), Tr.Get("MadmateFanatic")], MadmateSpawnRate);
        ...
        LastImpostorEnable = CustomOption.Header(4010, CustomOptionType.Modifier, "LastImpostorEnable", true, "LastImpostor");
        LastImpostorFunctions = CustomOption.Normal(4011, CustomOptionType.Modifier, "LastImpostorFunctions", [Tr.Get("LastImpostorDivine"), Tr.Get("LastImpostorGuesser")], LastImpostorEnable);
        ...
        LastImpostorResults = CustomOption.Normal(4013, CustomOptionType.Modifier, "FortuneTellerResults", [Tr.Get("FortuneTellerResultCrew"), Tr.Get("FortuneTellerResultTeam"), Tr.Get("FortuneTellerResultRole")], LastImpostorEnable);
