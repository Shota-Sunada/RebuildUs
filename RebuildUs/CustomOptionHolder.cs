...
#region MOD OPTIONS
        ...
        RandomNumberAlgorithm = CustomOption.Normal(3,
            CustomOptionType.General,
            TrKey.RandomNumberAlgorithm,
            [Tr.Get(TrKey.RndDotnet), Tr.Get(TrKey.RndMT), Tr.Get(TrKey.RndXoshiro256), Tr.Get(TrKey.RndXoshiro256Ss), Tr.Get(TrKey.RndPcg64)],
            0,
            EnableRandomRandomNumberAlgorithm);
        EnableRandomRandomNumberAlgorithmDotnet = CustomOption.Normal(4,
            CustomOptionType.General,
            TrKey.EnableRandomRandomNumberAlgorithmDotnet,
            true,
            EnableRandomRandomNumberAlgorithm);
        EnableRandomRandomNumberAlgorithmMT = CustomOption.Normal(5,
            CustomOptionType.General,
            TrKey.EnableRandomRandomNumberAlgorithmMT,
            true,
            EnableRandomRandomNumberAlgorithm);
        EnableRandomRandomNumberAlgorithmXorshiro256Pp = CustomOption.Normal(6,
            CustomOptionType.General,
            TrKey.EnableRandomRandomNumberAlgorithmXorshiro256Pp,
            true,
            EnableRandomRandomNumberAlgorithm);
        EnableRandomRandomNumberAlgorithmXorshiro256Ss = CustomOption.Normal(7,
            CustomOptionType.General,
            TrKey.EnableRandomRandomNumberAlgorithmXorshiro256Ss,
            true,
            EnableRandomRandomNumberAlgorithm);
        EnableRandomRandomNumberAlgorithmPcg64 = CustomOption.Normal(8,
            CustomOptionType.General,
            TrKey.EnableRandomRandomNumberAlgorithmPcg64,
            true,
            EnableRandomRandomNumberAlgorithm);
...
#region GAME OPTIONS
        ...
        AdditionalEmergencyCooldownTime = CustomOption.Normal(56,
            CustomOptionType.General,
            TrKey.AdditionalEmergencyCooldownTime,
            10f,
            0f,
            60f,
            1f,
        ...
        RestrictDevices = CustomOption.Normal(60,
            CustomOptionType.General,
            TrKey.RestrictDevices,
            [Tr.Get(TrKey.Off), Tr.Get(TrKey.RestrictPerTurn), Tr.Get(TrKey.RestrictPerGame)],
            0);
...
#region ROLES CREWMATE
        ...
        MayorTasksNeededToSeeVoteColors = CustomOption.Normal(1003,
            CustomOptionType.Crewmate,
            TrKey.MayorTasksNeededToSeeVoteColors,
            3f,
            1f,
            10f,
            1f,
        ...
        MayorMaxRemoteMeetings = CustomOption.Normal(1005,
            CustomOptionType.Crewmate,
            TrKey.MayorMaxRemoteMeetings,
            1f,
            0f,
            10f,
            1f,
        ...
        EngineerHighlightForImpostors = CustomOption.Normal(1012,
            CustomOptionType.Crewmate,
            TrKey.EngineerHighlightForImpostors,
            true,
            EngineerSpawnRate);
        EngineerHighlightForTeamJackal = CustomOption.Normal(1013,
            CustomOptionType.Crewmate,
            TrKey.EngineerHighlightForTeamJackal,
            true,
            EngineerSpawnRate);
        ...
        MedicShowShielded = CustomOption.Normal(1031,
            CustomOptionType.Crewmate,
            TrKey.MedicShowShielded,
            [Tr.Get(TrKey.MedicShowShieldedAll), Tr.Get(TrKey.MedicShowShieldedBoth), Tr.Get(TrKey.MedicShowShieldedMedic)],
            0,
            MedicSpawnRate);
        ...
        SeerMode = CustomOption.Normal(1041,
            CustomOptionType.Crewmate,
            TrKey.SeerMode,
            [Tr.Get(TrKey.SeerModeBoth), Tr.Get(TrKey.SeerModeFlash), Tr.Get(TrKey.SeerModeSouls)],
            0,
            SeerSpawnRate);
        ...
        TimeMasterCooldown = CustomOption.Normal(1051,
            CustomOptionType.Crewmate,
            TrKey.TimeMasterCooldown,
            30f,
            2.5f,
            120f,
            2.5f,
        ...
        TimeMasterShieldDuration = CustomOption.Normal(1053,
            CustomOptionType.Crewmate,
            TrKey.TimeMasterShieldDuration,
            3f,
            1f,
            20f,
            1f,
        ...
        DetectiveAnonymousFootprints = CustomOption.Normal(1061,
            CustomOptionType.Crewmate,
            TrKey.DetectiveAnonymousFootprints,
            false,
            DetectiveSpawnRate);
        DetectiveFootprintInterval = CustomOption.Normal(1062,
            CustomOptionType.Crewmate,
            TrKey.DetectiveFootprintInterval,
            0.5f,
            0.25f,
            10f,
            0.25f,
            DetectiveSpawnRate);
        DetectiveFootprintDuration = CustomOption.Normal(1063,
            CustomOptionType.Crewmate,
            TrKey.DetectiveFootprintDuration,
            5f,
            0.25f,
            10f,
            0.25f,
            DetectiveSpawnRate);
        DetectiveReportNameDuration = CustomOption.Normal(1064,
            CustomOptionType.Crewmate,
            TrKey.DetectiveReportNameDuration,
            10f,
            0,
            60,
            2.5f,
            DetectiveSpawnRate);
        DetectiveReportColorDuration = CustomOption.Normal(1065,
            CustomOptionType.Crewmate,
            TrKey.DetectiveReportColorDuration,
            20,
            0,
            120,
            2.5f,
        ...
        HackerHackingDuration = CustomOption.Normal(1082,
            CustomOptionType.Crewmate,
            TrKey.HackerHackingDuration,
            10f,
            2.5f,
            60f,
            2.5f,
        ...
        HackerRechargeTasksNumber = CustomOption.Normal(1085,
            CustomOptionType.Crewmate,
            TrKey.HackerRechargeTasksNumber,
            2f,
            1f,
            5f,
            1f,
        ...
        TrackerResetTargetAfterMeeting = CustomOption.Normal(1092,
            CustomOptionType.Crewmate,
            TrKey.TrackerResetTargetAfterMeeting,
            false,
            TrackerSpawnRate);
        ...
        TrackerCorpsesTrackingCooldown = CustomOption.Normal(1094,
            CustomOptionType.Crewmate,
            TrKey.TrackerCorpseCooldown,
            30f,
            0f,
            120f,
            5f,
            TrackerCanTrackCorpses);
        TrackerCorpsesTrackingDuration = CustomOption.Normal(1095,
            CustomOptionType.Crewmate,
            TrKey.TrackerCorpseDuration,
            5f,
            2.5f,
            30f,
            2.5f,
        ...
        SnitchLeftTasksForReveal = CustomOption.Normal(1101,
            CustomOptionType.Crewmate,
            TrKey.SnitchLeftTasksForReveal,
            1f,
            0f,
            5f,
            1f,
        ...
        SnitchTeamJackalUseDifferentArrowColor = CustomOption.Normal(1103,
            CustomOptionType.Crewmate,
            TrKey.SnitchTeamJackalUseDifferentArrowColor,
            true,
            SnitchIncludeTeamJackal);

        LighterSpawnRate = new(1110, CustomOptionType.Crewmate, RoleType.Lighter, Lighter.NameColor);
        LighterModeLightsOnVision = CustomOption.Normal(1111,
            CustomOptionType.Crewmate,
            TrKey.LighterModeLightsOnVision,
            2f,
            0.25f,
            5f,
            0.25f,
            LighterSpawnRate);
        LighterModeLightsOffVision = CustomOption.Normal(1112,
            CustomOptionType.Crewmate,
            TrKey.LighterModeLightsOffVision,
            0.75f,
            0.25f,
            5f,
            0.25f,
        ...
        SecurityGuardCooldown = CustomOption.Normal(1121,
            CustomOptionType.Crewmate,
            TrKey.SecurityGuardCooldown,
            30f,
            2.5f,
            60f,
            2.5f,
            SecurityGuardSpawnRate);
        SecurityGuardTotalScrews = CustomOption.Normal(1122,
            CustomOptionType.Crewmate,
            TrKey.SecurityGuardTotalScrews,
            7f,
            1f,
            15f,
            1f,
            SecurityGuardSpawnRate);
        SecurityGuardCamPrice = CustomOption.Normal(1123,
            CustomOptionType.Crewmate,
            TrKey.SecurityGuardCamPrice,
            2f,
            1f,
            15f,
            1f,
            SecurityGuardSpawnRate);
        SecurityGuardVentPrice = CustomOption.Normal(1124,
            CustomOptionType.Crewmate,
            TrKey.SecurityGuardVentPrice,
            1f,
            1f,
            15f,
            1f,
            SecurityGuardSpawnRate);
        SecurityGuardCamDuration = CustomOption.Normal(1125,
            CustomOptionType.Crewmate,
            TrKey.SecurityGuardCamDuration,
            10f,
            2.5f,
            60f,
            2.5f,
            SecurityGuardSpawnRate);
        SecurityGuardCamMaxCharges = CustomOption.Normal(1126,
            CustomOptionType.Crewmate,
            TrKey.SecurityGuardCamMaxCharges,
            5f,
            1f,
            30f,
            1f,
            SecurityGuardSpawnRate);
        SecurityGuardCamRechargeTasksNumber = CustomOption.Normal(1127,
            CustomOptionType.Crewmate,
            TrKey.SecurityGuardCamRechargeTasksNumber,
            3f,
            1f,
            10f,
            1f,
        ...
        BaitReportDelay = CustomOption.Normal(1142,
            CustomOptionType.Crewmate,
            TrKey.BaitReportDelay,
            0f,
            0f,
            10f,
            1f,
        ...
        SheriffCooldown = CustomOption.Normal(1161,
            CustomOptionType.Crewmate,
            TrKey.SheriffCooldown,
            30f,
            2.5f,
            60f,
            2.5f,
            SheriffSpawnRate,
            format: "unitSeconds");
        SheriffNumShots = CustomOption.Normal(1162,
            CustomOptionType.Crewmate,
            TrKey.SheriffNumShots,
            2f,
            1f,
            15f,
            1f,
        ...
        MadmateRoleHasImpostorVision = CustomOption.Normal(1173,
            CustomOptionType.Crewmate,
            TrKey.MadmateHasImpostorVision,
            false,
            MadmateRoleSpawnRate);
        ...
        MadmateRoleCanKnowImpostorAfterFinishTasks = CustomOption.Normal(1176,
            CustomOptionType.Crewmate,
            TrKey.MadmateCanKnowImpostorAfterFinishTasks,
            false,
            MadmateRoleSpawnRate);
        ...
        SuiciderCanKnowImpostorAfterFinishTasks = CustomOption.Normal(1195,
            CustomOptionType.Crewmate,
            TrKey.SuiciderCanKnowImpostorAfterFinishTasks,
            false,
            SuiciderSpawnRate);
...
#region ROLES IMPOSTOR
        ...
        BountyHunterBountyDuration = CustomOption.Normal(2001,
            CustomOptionType.Impostor,
            TrKey.BountyHunterBountyDuration,
            60f,
            10f,
            180f,
            10f,
            BountyHunterSpawnRate);
        BountyHunterReducedCooldown = CustomOption.Normal(20002,
            CustomOptionType.Impostor,
            TrKey.BountyHunterReducedCooldown,
            2.5f,
            2.5f,
            30f,
            2.5f,
            BountyHunterSpawnRate);
        BountyHunterPunishmentTime = CustomOption.Normal(2003,
            CustomOptionType.Impostor,
            TrKey.BountyHunterPunishmentTime,
            20f,
            0f,
            60f,
            2.5f,
        ...
        BountyHunterArrowUpdateInterval = CustomOption.Normal(2005,
            CustomOptionType.Impostor,
            TrKey.BountyHunterArrowUpdateInterval,
            15f,
            2.5f,
            60f,
            2.5f,
        ...
        TricksterPlaceBoxCooldown = CustomOption.Normal(2021,
            CustomOptionType.Impostor,
            TrKey.TricksterPlaceBoxCooldown,
            10f,
            2.5f,
            30f,
            2.5f,
            TricksterSpawnRate);
        TricksterLightsOutCooldown = CustomOption.Normal(2022,
            CustomOptionType.Impostor,
            TrKey.TricksterLightsOutCooldown,
            30f,
            5f,
            60f,
            5f,
            TricksterSpawnRate);
        TricksterLightsOutDuration = CustomOption.Normal(2023,
            CustomOptionType.Impostor,
            TrKey.TricksterLightsOutDuration,
            15f,
            5f,
            60f,
            2.5f,
        ...
        EvilHackerCanHasBetterAdmin = CustomOption.Normal(2031,
            CustomOptionType.Impostor,
            TrKey.EvilHackerCanHasBetterAdmin,
            false,
            EvilHackerSpawnRate);
        EvilHackerCanMoveEvenIfUsesAdmin = CustomOption.Normal(2032,
            CustomOptionType.Impostor,
            TrKey.EvilHackerCanMoveEvenIfUsesAdmin,
            true,
            EvilHackerSpawnRate);
        EvilHackerCanInheritAbility = CustomOption.Normal(2033,
            CustomOptionType.Impostor,
            TrKey.EvilHackerCanInheritAbility,
            false,
            EvilHackerSpawnRate);
        EvilHackerCanSeeDoorStatus = CustomOption.Normal(2034,
            CustomOptionType.Impostor,
            TrKey.EvilHackerCanSeeDoorStatus,
            true,
            EvilHackerSpawnRate);
        EvilHackerCanCreateMadmate = CustomOption.Normal(2035,
            CustomOptionType.Impostor,
            TrKey.EvilHackerCanCreateMadmate,
            false,
            EvilHackerSpawnRate);
        CreatedMadmateCanDieToSheriff = CustomOption.Normal(2036,
            CustomOptionType.Impostor,
            TrKey.CreatedMadmateCanDieToSheriff,
            false,
            EvilHackerCanCreateMadmate);
        CreatedMadmateCanEnterVents = CustomOption.Normal(2037,
            CustomOptionType.Impostor,
            TrKey.CreatedMadmateCanEnterVents,
            false,
            EvilHackerCanCreateMadmate);
        EvilHackerCanCreateMadmateFromJackal = CustomOption.Normal(2038,
            CustomOptionType.Impostor,
            TrKey.EvilHackerCanCreateMadmateFromJackal,
            false,
            EvilHackerCanCreateMadmate);
        CreatedMadmateHasImpostorVision = CustomOption.Normal(2039,
            CustomOptionType.Impostor,
            TrKey.CreatedMadmateHasImpostorVision,
            false,
            EvilHackerCanCreateMadmate);
        CreatedMadmateCanSabotage = CustomOption.Normal(2040,
            CustomOptionType.Impostor,
            TrKey.CreatedMadmateCanSabotage,
            false,
            EvilHackerCanCreateMadmate);
        CreatedMadmateCanFixComm = CustomOption.Normal(2041,
            CustomOptionType.Impostor,
            TrKey.CreatedMadmateCanFixComm,
            true,
            EvilHackerCanCreateMadmate);
        CreatedMadmateAbility = CustomOption.Normal(2042,
            CustomOptionType.Impostor,
            TrKey.MadmateAbility,
            [Tr.Get(TrKey.MadmateNone), Tr.Get(TrKey.MadmateFanatic)],
            0,
            EvilHackerCanCreateMadmate);
        CreatedMadmateNumTasks = CustomOption.Normal(2043,
            CustomOptionType.Impostor,
            TrKey.CreatedMadmateNumTasks,
            4f,
            1f,
            20f,
            1f,
            CreatedMadmateAbility);
        CreatedMadmateExileCrewmate = CustomOption.Normal(2044,
            CustomOptionType.Impostor,
            TrKey.CreatedMadmateExileCrewmate,
            false,
            EvilHackerCanCreateMadmate);
        ...
        EvilTrackerResetTargetAfterMeeting = CustomOption.Normal(2052,
            CustomOptionType.Impostor,
            TrKey.EvilTrackerResetTargetAfterMeeting,
            true,
            EvilTrackerSpawnRate);
        EvilTrackerCanSeeDeathFlash = CustomOption.Normal(2053,
            CustomOptionType.Impostor,
            TrKey.EvilTrackerCanSeeDeathFlash,
            true,
            EvilTrackerSpawnRate);
        EvilTrackerCanSeeTargetTask = CustomOption.Normal(2054,
            CustomOptionType.Impostor,
            TrKey.EvilTrackerCanSeeTargetTask,
            true,
            EvilTrackerSpawnRate);
        EvilTrackerCanSeeTargetPosition = CustomOption.Normal(2055,
            CustomOptionType.Impostor,
            TrKey.EvilTrackerCanSeeTargetPosition,
            true,
            EvilTrackerSpawnRate);
        EvilTrackerCanSetTargetOnMeeting = CustomOption.Normal(2056,
            CustomOptionType.Impostor,
            TrKey.EvilTrackerCanSetTargetOnMeeting,
            true,
            EvilTrackerSpawnRate);

        EraserSpawnRate = new(2060, CustomOptionType.Impostor, RoleType.Eraser, Eraser.NameColor, 1);
        EraserCooldown = CustomOption.Normal(2061,
            CustomOptionType.Impostor,
            TrKey.EraserCooldown,
            30f,
            5f,
            120f,
            5f,
            EraserSpawnRate,
            format: "unitSeconds");
        EraserCooldownIncrease = CustomOption.Normal(2062,
            CustomOptionType.Impostor,
            TrKey.EraserCooldownIncrease,
            10f,
            0f,
            120f,
            2.5f,
        ...
        MorphingCooldown = CustomOption.Normal(2071,
            CustomOptionType.Impostor,
            TrKey.MorphingCooldown,
            30f,
            2.5f,
            60f,
            2.5f,
            MorphingSpawnRate,
            format: "unitSeconds");
        MorphingDuration = CustomOption.Normal(2072,
            CustomOptionType.Impostor,
            TrKey.MorphingDuration,
            10f,
            1f,
            20f,
            0.5f,
        ...
        CamouflagerCooldown = CustomOption.Normal(2081,
            CustomOptionType.Impostor,
            TrKey.CamouflagerCooldown,
            30f,
            2.5f,
            60f,
            2.5f,
            ...
            format: "unitSeconds");
        CamouflagerDuration = CustomOption.Normal(2082,
            CustomOptionType.Impostor,
            TrKey.CamouflagerDuration,
            10f,
            1f,
            20f,
            0.5f,
        ...
        CleanerCooldown = CustomOption.Normal(2091,
            CustomOptionType.Impostor,
            TrKey.CleanerCooldown,
            30f,
            2.5f,
            60f,
            2.5f,
        ...
        WarlockCooldown = CustomOption.Normal(2101,
            CustomOptionType.Impostor,
            TrKey.WarlockCooldown,
            30f,
            2.5f,
            60f,
            2.5f,
            WarlockSpawnRate,
            format: "unitSeconds");
        WarlockRootTime = CustomOption.Normal(2102,
            CustomOptionType.Impostor,
            TrKey.WarlockRootTime,
            5f,
            0f,
            15f,
            1f,
        ...
        WitchCooldown = CustomOption.Normal(2111,
            CustomOptionType.Impostor,
            TrKey.WitchSpellCooldown,
            30f,
            2.5f,
            120f,
            2.5f,
            WitchSpawnRate,
            format: "unitSeconds");
        WitchAdditionalCooldown = CustomOption.Normal(2112,
            CustomOptionType.Impostor,
            TrKey.WitchAdditionalCooldown,
            10f,
            0f,
            60f,
            5f,
        ...
        WitchSpellCastingDuration = CustomOption.Normal(2114,
            CustomOptionType.Impostor,
            TrKey.WitchSpellDuration,
            1f,
            0f,
            10f,
            1f,
        ...
        VampireKillDelay = CustomOption.Normal(2121,
            CustomOptionType.Impostor,
            TrKey.VampireKillDelay,
            10f,
            1f,
            20f,
            1f,
            VampireSpawnRate,
            format: "unitSeconds");
        VampireCooldown = CustomOption.Normal(2122,
            CustomOptionType.Impostor,
            TrKey.VampireCooldown,
            30f,
            2.5f,
            60f,
            2.5f,
...
#region ROLES NEUTRAL
        ...
        JackalCreateSidekickCooldown = CustomOption.Normal(3036,
            CustomOptionType.Neutral,
            TrKey.JackalCreateSidekickCooldown,
            30f,
            10f,
            60f,
            2.5f,
        ...
        SidekickCanSabotageLights = CustomOption.Normal(3040,
            CustomOptionType.Neutral,
            TrKey.SidekickCanSabotageLights,
            true,
            JackalCanCreateSidekick);
        SidekickHasImpostorVision = CustomOption.Normal(3041,
            CustomOptionType.Neutral,
            TrKey.SidekickHasImpostorVision,
            false,
            JackalCanCreateSidekick);
        SidekickPromotesToJackal = CustomOption.Normal(3037,
            CustomOptionType.Neutral,
            TrKey.SidekickPromotesToJackal,
            false,
            JackalCanCreateSidekick);
        JackalPromotedFromSidekickCanCreateSidekick = CustomOption.Normal(3042,
            CustomOptionType.Neutral,
            TrKey.JackalPromotedFromSidekickCanCreateSidekick,
            false,
            SidekickPromotesToJackal);
        JackalCanCreateSidekickFromImpostor = CustomOption.Normal(3043,
            CustomOptionType.Neutral,
            TrKey.JackalCanCreateSidekickFromImpostor,
            false,
            JackalCanCreateSidekick);
        ...
        GuesserHasMultipleShotsPerMeeting = CustomOption.Normal(3055,
            CustomOptionType.Neutral,
            TrKey.GuesserHasMultipleShotsPerMeeting,
            false,
            GuesserSpawnRate);
...
#region MODIFIERS
        ...
        MadmateType = CustomOption.Normal(4001,
            CustomOptionType.Modifier,
            TrKey.MadmateType,
            [Tr.Get(TrKey.MadmateDefault), Tr.Get(TrKey.MadmateWithRole), Tr.Get(TrKey.MadmateRandom)],
            0,
            MadmateSpawnRate);
        MadmateFixedRole = new(4002, CustomOptionType.Modifier, TrKey.MadmateFixedRole, Madmate.ValidRoles, MadmateType);
        MadmateAbility = CustomOption.Normal(4003,
            CustomOptionType.Modifier,
            TrKey.MadmateAbility,
            [Tr.Get(TrKey.MadmateNone), Tr.Get(TrKey.MadmateFanatic)],
            0,
        ...
        LastImpostorFunctions = CustomOption.Normal(4011,
            CustomOptionType.Modifier,
            TrKey.LastImpostorFunctions,
            [Tr.Get(TrKey.LastImpostorDivine), Tr.Get(TrKey.LastImpostorGuesser)],
            0,
            LastImpostorEnable);
        ...
        LastImpostorResults = CustomOption.Normal(4013,
            CustomOptionType.Modifier,
            TrKey.FortuneTellerResults,
            [Tr.Get(TrKey.FortuneTellerResultCrew), Tr.Get(TrKey.FortuneTellerResultTeam), Tr.Get(TrKey.FortuneTellerResultRole)],
            0,
            LastImpostorEnable);
        ...
        LoversNumCouples = CustomOption.Normal(4022,
            CustomOptionType.Modifier,
            TrKey.LoversNumCouples,
            1f,
            1f,
            7f,
            1f,
        ...
        MiniGrowingUpDuration = CustomOption.Normal(181,
            CustomOptionType.Modifier,
            TrKey.MiniGrowingUpDuration,
            400f,
            100f,
            1500f,
            100f,
