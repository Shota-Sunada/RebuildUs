...
[HarmonyPatch]
internal static class TransportationToolPatches
{
    /*
    ...
    internal static bool IsUsingTransportation(PlayerControl pc)
    {
    ...
    internal static void Prefix3(ZiplineBehaviour __instance, PlayerControl player, bool fromTop)
    {
