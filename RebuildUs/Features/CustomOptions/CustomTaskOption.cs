...
internal sealed class CustomTasksOption((COID commonId, COID shortId, COID longId) ids, COType type, (int commonTasks, int shortTasks, int longTasks) defaultValue, CustomOption parent = null)
{
